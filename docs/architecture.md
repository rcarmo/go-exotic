...
The future `LayerShardExecutor` shape is present but intentionally not implemented. It will be used only after activation serialization, KV/state ownership, and multi-worker simulation are tested.
